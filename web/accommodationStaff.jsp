...
<body>
<form action="servlet/addServlet" autocomplete="on" method="post">
    ...
    <div class="form_table">
        ...
        <div id="q44" class="q full_width">
            ...
            <div class="segment_header" style="width:auto;text-align:center;"><h1 style="font-size:18px;padding:20px 1em ;">Accommodation Staff</h1></div>
        </div>
        ...
        <div id="q2" class="q">
            ...
            <input type="text" name="staffno" class="text_field" id="RESULT_TextField-1"  size="62" maxlength="25" value="" />
        </div>
        ...
        <div id="q48" class="q">
            ...
            <input type="text" name="name" class="text_field" id="RESULT_TextField-2"  size="62" maxlength="25" value="" />
        </div>
        ...
        <div id="q33" class="q">
            ...
            <input type="text" name="address" class="text_field" id="RESULT_TextField-3"  size="62" maxlength="62" value="" />
        </div>
        ...
        <div id="q4" class="q">
            ...
            <input type="text" name="birthday" class="text_field" id="RESULT_TextField-4"  size="62" maxlength="35" value="" />
        </div>
        ...
        <div id="q5" class="q">
            ...
            <input type="text" name="sex" class="text_field" id="RESULT_TextField-5"  size="62" maxlength="35" value="" />
        </div>
        ...
        <div id="q6" class="q">
            ...
            <input type="text" name="position" class="text_field" id="RESULT_TextField-6"  size="62" maxlength="62" value="" />
        </div>
        ...
        <div id="q7" class="q">
            ...
            <input type="text" name="location" class="text_field" id="RESULT_TextField-7"  size="62" maxlength="62" value="" />
        </div>
        <div class="clear"></div>
